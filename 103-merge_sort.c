...
/**
 * merge_s -sort a subarray of integers.
 *
...
void merge_s(int *subarr, int *buff, size_t front, size_t mid,
		size_t back)
{
	size_t i, j, k = 0;
...
/**
 * merge_recursive - implement the merge through recursion.
 *
...
void merge_recursive(int *subarr, int *buff, size_t front, size_t back)
{
	...
	if (back - front > 1)
	{
		...
		merge_s(subarr, buff, front, mid, back);
	}
}
